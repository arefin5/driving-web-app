  ...
  return (
    <Modal
      ...
      classNames={{
        ...
        base: "border-[#292f46] bg-white max-w-[400px] p-[30px] text-black",
          ...
          <>
            ...
            <ModalBody>
              <div className="flex flex-col gap-6  rounded-lg">
                ...
                <p className="text-center text-xl font-semibold primary-text-color">
                  {message}
                </p>
              </div>
            </ModalBody>
...
export default ConformSingUpModal;
