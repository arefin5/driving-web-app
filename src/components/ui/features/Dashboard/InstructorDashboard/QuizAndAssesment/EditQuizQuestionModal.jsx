...
const EditQuizQuestionModal = ({ isOpen, onOpenChange, quizId }) => {
...
const [refetch,setRefetch]=useState(false);
  ...
  const {
    ...
    onOpenChange: onOpenChangeEditQuestion,
  } = useDisclosure();
              ...
              <ModalHeader className="flex items-center gap-1">
                ...
                <div>
                  ...
                  <p className="text-base font-normal -mt-2">
                    প্রশ্ন আপডেট করার জন্য এডিট বাটনে ক্লিক করুন
                  </p>
                </div>
              </ModalHeader>
              <ModalBody>
                <div>
                  {allData?.map((formData) => (
                    <div
                      key={formData?._id}
                      className="flex flex-col  pt-4  gap-3 border-[#CE2786] border-t border-solid mb-4"
                    >
                      <div className="flex justify-between">
                        <InputLabel label={`কুইজের প্রশ্ন`} />
                        <button
                          onClick={() => {
                            setQuestionId(formData?._id);
                            onOpenEditQuestion();
                          }}
                          className="bg-[#CE2786]  rounded-md text-white p-2"
                        >
                          <FaRegEdit />
                        </button>
                      </div>
