...
const ViewLiveClassModal = ({ isOpen, onOpenChange, liveClassId }) => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `https://backend.driveshikhun.com/api/v1/liveClasses/getLiveClassesById/${liveClassId}`
        );
                  ...
                  <div className="flex gap-5 items-center justify-between">
                    ...
                    <div className="basis-1/4 flex flex-col w-full gap-2 mb-3 text-black/50">
                      ...
                      <input
                        required
                        type="date"
                        value={liveClass?.startingDate} // Set the value from liveClass state
                    ...
                    <div className=" basis-1/4 flex flex-col w-full gap-2 mb-3 text-black/50">
                      ...
                      <input
                        required
                        type="text"
                        value={liveClass?.StartingTime} // Set the value from liveClass state
                        placeholder="HH : MM"
                        className="py-3 px-4 border border-solid rounded border-black/30 outline-0 text-black/50 placeholder:text-black/50 placeholder:text-xs  dark:placeholder:text-white dark:bg-transparent dark:border-white dark:text-white"
                      />
                    </div>
                  ...
                  <div className="flex gap-5 items-center justify-between">
                    <div className="flex flex-col w-full gap-2 mb-3 relative">
                      ...
                      <select
                        ...
                        name=""
                        // Set the value from liveClass state
                      >
                        <option value={liveClass?.selectCourse}>
                          {liveClass?.selectCourse}
                        </option>
                      </select>
                    ...
                    <div className="flex flex-col w-full gap-2 mb-3 relative">
                      <InputLabel label="ইনস্ট্রাক্টর নাম" />
                      <select
                        defaultValue={"ইনস্ট্রাক্টর নাম সিলেক্ট করুন..."}
                        className="py-3 text-black/30 appearance-none px-5  border border-solid rounded focus:text-black border-black/30 outline-0 placeholder:text-black/50  dark:placeholder:text-white dark:bg-transparent dark:border-white dark:text-white"
                        name=""
                        id=""
                      >
                        <option value={liveClass?.instructorName}>
...
export default ViewLiveClassModal;
